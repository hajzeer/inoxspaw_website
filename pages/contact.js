...
const handleSubmit = () => {
    ...
    return (
        ...
        <ContactFormStyled >
                ...
                <InputStyle ref={ el => (name = el)} type='text' placeholder='Imię i nazwisko' />
                <LabelStyled >Email</LabelStyled>
                <InputStyle ref={el => (email = el)} type='email' placeholder='Email'/>
                <LabelStyled>Temat</LabelStyled>
                <SelectStyled >
                {
                    categories.map(({Name, id}) => {
                        return(
                      <OptionStyled key={id} value={Name} >{Name}</OptionStyled>
                        )
                    })
                }
                </SelectStyled>
                <LabelStyled  >Wiadomość</LabelStyled>
                <TextAreaStyle ref={el => (message = el)} placeholder='WIADOMOŚĆ'/>
